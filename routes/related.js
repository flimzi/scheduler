...
router.get(
    ...
    asyncHandler(async (req, res) => res.send(await req.targetUser.getPrimary(joinInts(req.query.type))))
)
...
router.get(
    ...
    validate,
    related(true, false, RelationshipTypes.Owner),
    asyncHandler(async (req, res) => res.send(await req.targetUser.getSecondary(joinInts(req.query.type))))
)
